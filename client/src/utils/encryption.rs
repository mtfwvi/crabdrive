...
pub async fn decrypt_node(node: EncryptedNode, key: EncryptionKey) -> Result<DecryptedNode, JsValue> {
...
pub async fn encrypt_node(node: DecryptedNode, key: EncryptionKey) -> Result<EncryptedNode, JsValue> {
