...
pub fn get_example_login_success() -> LoginSuccess {
    LoginSuccess::new("".to_string(), "".to_string(), "".to_string(), "".to_string(), false)
}


pub async fn post_login(Json(_payload): Json<PostLoginRequest>) -> (StatusCode, Json<PostLoginResponse>) {
    //TODO implement
    (StatusCode::OK, Json(PostLoginResponse::Ok(get_example_login_success())))
}

pub async fn post_register(Json(_payload): Json<PostRegisterRequest>) -> (StatusCode, Json<PostRegisterResponse>) {
    //TODO implement
