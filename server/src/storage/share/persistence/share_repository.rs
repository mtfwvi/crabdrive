...
use crate::db::operations::{delete_share, get_all_shares_by_node, get_all_shares_by_user, get_share_by_user_node, insert_share, select_share, update_share};
...
pub trait ShareRepository {
    ...
    fn get_share_by_node_id_and_user_id(&self, node_id: NodeId, user_id: UserId) -> Result<Option<ShareEntity>>;
}
